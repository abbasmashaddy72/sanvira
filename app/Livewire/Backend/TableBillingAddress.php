...
final class TableBillingAddress extends PowerGridComponent
{
    use WithExport;
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('landmark')
            ->addColumn('zip_code')
            ->addColumn('created_at_formatted', fn (BillingAddress $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
