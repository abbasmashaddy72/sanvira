    ...
    <ul class="submenu megamenu">
        <li>
            <ul>
                ...
                <li><a href="index-classic-app.html" class="sub-menu-item">Classic App <span
        ...
        <li>
            <ul>
                ...
                <li><a href="index-it-solution-two.html" class="sub-menu-item">It Solution Two <span
                            class="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ml-1">New</span></a>
                </li>
        ...
        <li>
            <ul>
                ...
                <li><a href="index-insurance.html" class="sub-menu-item">Insurance <span
                            class="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ml-1">New</span></a>
                </li>
                <li><a href="index-construction.html" class="sub-menu-item">Construction <span
                            class="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ml-1">New</span></a>
                </li>
            </ul>
        </li>
    ...
    <ul class="submenu">
        <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> Company </a><span
            ...
            <ul class="submenu">
                ...
                <li><a href="page-testimonial.html" class="sub-menu-item">Testimonial <span
                            class="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ml-1">New</span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> Blog <span
            ...
            <ul class="submenu">
                ...
                <li class="has-submenu child-menu-item"><a href="javascript:void(0)"> Blog Posts <span
                            class="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ml-1">New</span></a><span
                        class="submenu-arrow"></span>
                    <ul class="submenu">
