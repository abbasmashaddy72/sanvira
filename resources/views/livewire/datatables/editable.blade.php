<div x-data="{
    ...
    <button class="-mx-2 -my-1 min-h-[28px] w-full rounded px-2 py-1 text-left hover:bg-blue-100 focus:outline-none"
    ...
    <span x-cloak x-show="edit">
        <input class="-mx-2 -my-1 rounded border-blue-400 px-2 py-1 focus:border focus:outline-none" x-ref="input"
