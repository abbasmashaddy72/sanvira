            ...
            <x-slot name='containerSlotData'>
                <div class="flex flex-wrap gap-2">
                    <button wire:click="applyButton('onSale')" {{ $setButton == 'onSale' ? 'disabled' : '' }}
                        ...
                        @else border-gray-200 text-gray-700 @endif rounded-lg border-2 bg-white px-2 py-2 font-medium hover:border-2 hover:border-blue-600 hover:text-blue-600">On
                        Sale</button>
                    <button wire:click="applyButton('relevance')" {{ $setButton == 'relevance' ? 'disabled' : '' }}
                        ...
                        @else border-gray-200 text-gray-700 @endif rounded-lg border-2 bg-white px-2 py-2 font-medium hover:border-2 hover:border-blue-600 hover:text-blue-600">Relevance</button>
                    <button wire:click="applyButton('lowToHigh')" {{ $setButton == 'lowToHigh' ? 'disabled' : '' }}
                        ...
                        @else border-gray-200 text-gray-700 @endif rounded-lg border-2 bg-white px-2 py-2 font-medium hover:border-2 hover:border-blue-600 hover:text-blue-600">Price:
                        Low to High</button>
