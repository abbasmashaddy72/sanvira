<x-backend.modal-form form-action="add" title="{{ $name }}">
    <div class="grid gap-y-2">
        <x-select label="{{ __('Select Brand') }}" wire:model.defer="brand_id" placeholder="Select Brand" :async-data="route('api.admin.brands')"
            option-label="name" option-value="id" required />

        <x-native-select label="{{ __('Select Account Type') }}" placeholder="Select  Account Type" :options="getEnum('brand_transactions', 'account_type')"
        ...
        <x-native-select label="{{ __('Select Transaction Type') }}" placeholder="Select Transaction Type"
            :options="getEnum('brand_transactions', 'transaction_type')" wire:model.defer="transaction_type" />
        ...
        <x-native-select label="{{ __('Select Account Status') }}" placeholder="Select Account Status" :options="getEnum('brand_transactions', 'status')"
