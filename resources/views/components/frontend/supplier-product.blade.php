<div
    ...
    <a href="{{ route('products_details', ['data' => $item->id]) }}">
        <div class="relative">
            ...
            @if ($item->on_sale)
                <span
                    class="absolute top-0 left-0 z-10 inline-flex px-3 py-2 mt-3 ml-3 text-sm font-medium text-white bg-green-600 rounded-lg">
                    On Sale
                </span>
            @endif
        </div>
        ...
        <div class="flex items-center justify-between px-6 py-2 border-b border-gray-300">
            <div class="flex">
                <svg class="w-6 h-6 mr-2 fill-blue-600" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 118.67 122.88"
            ...
            <div class="flex">
                <svg class="w-6 h-6 mr-2 fill-blue-600" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-center justify-between px-6 py-2 border-b border-gray-300">
            <svg class="w-6 h-6 mr-2 fill-blue-600" id="Layer_1" data-name="Layer 1"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98.06 122.88">
                <defs>
                    <style>
                        .cls-1 {
                            fill-rule: evenodd;
        ...
        <div class="flex items-center justify-between px-6 py-2 border-b border-gray-300">
            <svg class="w-6 h-6 mr-2 fill-blue-600" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="121.7px"
                height="122.881px" viewBox="0 0 121.7 122.881" enable-background="new 0 0 121.7 122.881"
                xml:space="preserve">
                <g>
                    <path
