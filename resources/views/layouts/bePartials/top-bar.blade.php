<div class="float-right top-bar sm:float-none">
    {{ $breadcrumb }}
    ...
    <div class="mr-4">
        ...
        <a href="{{ route('supplier_profile', ['slug' => $supplier_slug]) }}" target="__blank">
            <svg class="w-5 h-5 text-gray-500 hover:bg-gray-100" xmlns="http://www.w3.org/2000/svg" width="24"
