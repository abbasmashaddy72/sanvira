                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-0 flex-1 pt-0.5"
                            ...
                            <p class="text-secondary-900 dark:text-secondary-400 text-sm font-medium"
                                x-show="notification.title" x-html="notification.title">
                            </p>
                            <p class="text-secondary-500 mt-1 text-sm" x-show="notification.description"
                        ...
                        <div class="ml-4 flex shrink-0">
                            ...
                            <!-- close button -->
                            <button
                                class="text-secondary-400 hover:text-secondary-500 inline-flex rounded-md focus:outline-none"
